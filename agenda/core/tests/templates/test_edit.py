...
class Edit_Contact_OK_Test(TestCase):
    def setUp(self):
        ...
        self.agenda = Agenda.objects.create(
            nome_completo='rafaela lemes',
            telefone='19999644110',
            email='rafa.lemes@fatec.sp.gov.br',
            observacao=''
        )
    ...
    def test_edit_post_data(self):
        ...
        data= {
            'id': self.agenda.pk,
            'nome_completo' : 'rafaela teste edit',
        ...
        self.assertTrue(Agenda.objects.filter(nome_completo='rafaela teste edit').exists())  # Confirma que o nome foi alterado
    ...
    def test_edit_post_invalid_data(self):
        ...
        self.assertTrue(Agenda.objects.filter(nome_completo='rafaela lemes').exists())
    ...
    def teste_edit_post_invalid_id(self):
        # testea envio de um ID que não existe na base de dados
        self.client.login(email='admin@fatec.sp.gov.br', password='fatec', username='admin')
        data= {
